...
export const Settings = () => {
    return (
        <>
            <div>
                <h2 className="text-2xl px-5 p-10 flex"><svg onClick={() => {window.location.hash = "#/profile/"+api.authStore.model.id;}} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 mt-1 mr-4">
                ...
                }} className="text-xl pb-5 px-5 flex"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 mt-1 mr-2">
                ...
                <p onClick={() => {
                    document.getElementById("tos").showModal();
                }} className="text-xl pb-5 px-5 flex"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 mt-1 mr-2">
            ...
            <Modal id="logout" height="h-screen">
                ...
                <div>
                    ...
                    <button className="rounded mt-1 p-2 mx-2 bg-gray-500 text-white w-full">Logout</button>
                </div>
            </Modal>
