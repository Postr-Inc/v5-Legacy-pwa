...
export const Settings = () => {
    return (
        <>
            <div>
                <h2 className="text-2xl px-5 p-10 flex"><svg onClick={() => {window.location.hash = "#/profile/"+api.authStore.model.id;}} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6 mt-1 mr-4">
