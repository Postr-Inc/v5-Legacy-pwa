    ...
    return(
        ...
        >
          <div class="flex flex-row gap-2">
            <img src={avatar} class="w-12 h-12 rounded-full object-cover" alt={props.author.username + ' Profile Image'} />
          ...
          <div class="flex flex-row gap-5 mt-6">
            
           {
            ...
            <svg
              ...
              xmlns="http://www.w3.org/2000/svg" fill={likes.includes(api.authStore.model.id) ? '#F13B38' : 'none'}
              viewBox="0 0 24 24" stroke-width="1.5" stroke={likes.includes(api.authStore.model.id) ? '#F13B38' : 'currentColor'}
